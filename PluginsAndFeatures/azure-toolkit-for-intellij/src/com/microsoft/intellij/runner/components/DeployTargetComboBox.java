...
public abstract class DeployTargetComboBox<T> extends ComboBox {

    public DeployTargetComboBox() {
        this(Collections.emptyList());
    }

    public DeployTargetComboBox(List<T> items){
    ...
    public abstract Icon getComboBoxItemIcon(T selectedItem);
